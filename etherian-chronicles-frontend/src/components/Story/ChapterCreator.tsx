...
const ChapterCreator = ({ storyId, chapterNumber, onChapterCreated, onCancel }: ChapterCreatorProps) => {
  ...
  return (
    <Card className="p-6">
      <div className="flex items-center space-x-3 mb-6">
        ...
        <h2 className="text-xl font-display font-bold">Create Chapter {chapterNumber}</h2>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* Chapter Content */}
        <div className="space-y-2">
          <Label htmlFor="content">Chapter Content * (max 5000 characters)</Label>
          <Textarea
            id="content"
